...
global.email = 'eloimekatula7@gmail.com'
global.github = 'https://github.com/Elohime7'
global.location = 'africa/kinshasa'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'ᏢᎽᎠᏒᎾᎨᎠ' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'NᏒᎽᎠᎬᏒ ᏰᏝᎯᏃᎬ' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'Naveed-Dogar' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'true' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'ᏢᎽᎠᏒᎾᎨᎠ' : process.env.PACK_NAME.split(";")[1],
